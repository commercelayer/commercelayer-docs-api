...
An **external promotion** object is returned as part of the response body of each successful
[create](https://docs.commercelayer.io/api/resources/external_promotions/create_external_promotion),
[list](https://docs.commercelayer.io/api/resources/external_promotions/list_external_promotions),
[retrieve](https://docs.commercelayer.io/api/resources/external_promotions/retrieve_external_promotion),
or [update](https://docs.commercelayer.io/api/resources/external_promotions/update_external_promotion) API call.
