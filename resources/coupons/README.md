...
A **coupon** object is returned as part of the response body of each successful
[create](https://docs.commercelayer.io/api/resources/coupons/create_coupon),
[list](https://docs.commercelayer.io/api/resources/coupons/list_coupons),
[retrieve](https://docs.commercelayer.io/api/resources/coupons/retrieve_coupon),
or [update](https://docs.commercelayer.io/api/resources/coupons/update_coupon) API call.
