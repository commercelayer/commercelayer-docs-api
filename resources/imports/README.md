...
| attributes.**parent\_resource\_id** | `string` | The ID of the parent resource. It can be the 'shipping\_category\_id' for 'skus', the 'price\_list\_id' for 'prices', or the 'stock\_location\_id' for 'stock\_items' |
