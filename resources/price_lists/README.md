...
A **price list** object is returned as part of the response body of each successful [create](https://docs.commercelayer.io/api/resources/price_lists/create_price_list), [list](https://docs.commercelayer.io/api/resources/price_lists/list_price_lists), [retrieve](https://docs.commercelayer.io/api/resources/price_lists/retrieve_price_list), or [update](https://docs.commercelayer.io/api/resources/price_lists/update_price_list) API call.
