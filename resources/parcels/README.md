...
A parcel object is returned as part of the response body of each successful [create](create-parcel.md), [list](list-all-parcels.md), [retrieve](retrieve-parcel.md) or [update](update-parcel.md) API call.
...
| relationships.**shipment** | `has_one` | The associated shipment. |
| relationships.**parcel_line_items** | `has_many` | The line items in this parcel (a subset of the shipment line items) |
