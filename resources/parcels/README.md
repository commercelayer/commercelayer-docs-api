...
A **parcel** object is returned as part of the response body of each successful [create](https://docs.commercelayer.io/resources/parcels/create_parcel), [list](https://docs.commercelayer.io/resources/parcels/list_parcels), [retrieve](https://docs.commercelayer.io/resources/parcels/retrieve_parcel), or [update](https://docs.commercelayer.io/resources/parcels/update_parcel) API call.
