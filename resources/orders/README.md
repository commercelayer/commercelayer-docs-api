...
| attributes.**authorization\_amount\_cents** | `integer` | The amount to be authorized, in cents. |
| attributes.**authorization\_amount\_float** | `float` | The amount to be authorized, float. |
| attributes.**formatted\_authorization\_amount** | `string` | The amount to be authorized, formatted. |
| attributes.**authorization\_balance\_cents** | `integer` | The balance to be authorized, in cents. |
| attributes.**authorization\_balance\_float** | `float` | The balance to be authorized, float. |
| attributes.**formatted\_authorization\_balance** | `string` | The balance to be authorized, formatted. |
