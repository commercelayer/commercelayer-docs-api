...
A **shipment** object is returned as part of the response body of each successful create, list, retrieve, or update API call.
...
| relationships.**delivery\_lead\_time** | `object` | The delivery lead time for the shipment. |
