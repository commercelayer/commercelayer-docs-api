...
| attributes.**rates** | `object` | The available shipping rates. |
...
| attributes.**purchase\_error\_code** | `string` | The shipping rate purchase error code, if any. |
| attributes.**purchase\_error\_message** | `string` | The shipping rate purchase error message, if any. |
| attributes.**get\_rates\_started\_at** | `datetime` | Time at which the getting of the shipping rates started. |
| attributes.**get\_rates\_completed\_at** | `datetime` | Time at which the getting of the shipping rates completed. |
| attributes.**purchase\_started\_at** | `datetime` | Time at which the purchasing of the shipping rate started. |
| attributes.**purchase\_completed\_at** | `datetime` | Time at which the purchasing of the shipping rate completed. |
| attributes.**purchase\_failed\_at** | `datetime` | Time at which the purchasing of the shipping rate failed. |
...
| relationships.**origin\_address** | `object` | The associated stock location address. |
...
| relationships.**delivery\_lead\_time** | `object` | The delivery lead time for the shipment. Equals the one associated with the shipping method selected by the customer. |
...
| relationships.**carrier\_accounts** | `array` | The carrier accounts available for the order's market. |
