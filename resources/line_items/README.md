...
| attributes.**item\_type** | `string` | The type of the associate item. Can be one of 'sku', 'shipment', 'payment\_method', 'adjustment', 'gift\_card', or a valid promotion type. |
