...
A **promotion** object is returned as part of the response body of each successful
[create](https://docs.commercelayer.io/api/resources/promotions/create_promotion),
[list](https://docs.commercelayer.io/api/resources/promotions/list_promotions),
[retrieve](https://docs.commercelayer.io/api/resources/promotions/retrieve_promotion),
or [update](https://docs.commercelayer.io/api/resources/promotions/update_promotion) API call.
