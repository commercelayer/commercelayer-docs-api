...
1. Create a [test environment](introduction.md#create-a-test-environment)
2. Get your [credentials](introduction.md#get-your-credentials)
3. Get an [access token](introduction.md#get-an-access-token)
4. Make your first [API call](introduction.md#make-your-first-api-call)
